...
export default {
  ...
  methods: {
    addDateToTimeline(rawData) {
      const rawTimeline = {
        id: 100000000000 - new Date(rawData.date.toDate()).getTime(),
    ...
    <div class="timeline-wrapper">
      <div class="timelime-item" v-for="kTimeline in TIMELINES" v-bind:key="kTimeline.year">
        <div
          ...
          v-for="kDates in kTimeline.dates "
          v-bind:key="kDates.id"
        >
          <div class="col dates" :class="['gi-'+kTimeline.color]">
            <h4 v-if="kDates.id==0">{{ kDates.date.getFullYear() }}</h4>
          </div>
        ...
        <div class="timeline-item-type-division">
          <img
            ...
            src="../../assets/timeline/DIV_0.png"
            alt
            v-if="kTimeline.color=='green'"
            width="100%"
          >
          <img
            class="div-icon div-icon-orange"
            src="../../assets/timeline/DIV_1.png"
            alt
            v-if="kTimeline.color=='orange'"
            width="100%"
          >
          <img
            class="div-icon div-icon-red"
            src="../../assets/timeline/DIV_2.png"
            alt
            v-if="kTimeline.color=='red'"
            width="100%"
          >
          <img
            class="div-icon div-icon-yellow"
            src="../../assets/timeline/DIV_3.png"
            alt
            v-if="kTimeline.color=='yellow'"
            width="100%"
          >
        </div>
      </div>
