  ...
  methods: {
    ...
    updateScrollToId(){
       if(this.scrollToId == 'dlz'){
          ...
          setTimeout( () => {VueScrollTo.scrollTo('#business-dlz');},500);
        }else{
        ...
        if(this.scrollToId == 'ready_meals'){
          ...
          setTimeout( () => {VueScrollTo.scrollTo('#business-ready-meals');},500);
        }else{
        ...
        if(this.scrollToId == 'start_up'){
          ...
          setTimeout( () => {VueScrollTo.scrollTo('#business-start-ups');},500);
        }else{
  ...
  <div class="view business">
    ...
    <div class="view-content">
      ...
      <section  v-for="section in sections" v-bind:key="section.id" 
                class="section business" :class="[ section.ui.colorClass , section.ui.displayClass ]">
